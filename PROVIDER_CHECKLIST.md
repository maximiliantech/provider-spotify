...
The [provider-spotify](https://github.com/maximiliantech/provider-spotify) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-spotify](https://github.com/crossplane-contrib/provider-jet-spotify) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/maximiliantech/provider-spotify/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/maximiliantech/provider-spotify/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/maximiliantech/provider-spotify/blob/main/hack/boilerplate.go.txt](https://github.com/maximiliantech/provider-spotify/blob/main/hack/boilerplate.go.txt)
...
The [provider-spotify](https://github.com/maximiliantech/provider-spotify)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/maximiliantech/provider-spotify/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/maximiliantech/provider-spotify/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue spotifys (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/maximiliantech/provider-spotify/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Spotifys: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/maximiliantech/provider-spotify/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
